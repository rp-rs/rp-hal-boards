...
```toml
waveshare_rp2040_lcd_1_69 = "0.1.0"
```

In your program, you will need to call `waveshare_rp2040_lcd_1_69::Pins::new` to create
...
```console
rp-hal-boards/boards/waveshare-rp2040-lcd-1-69 $ cargo build --release --example <name>
```
...
```console
rp-hal-boards/boards/waveshare-rp2040-lcd-1-69 $ cargo run --release --example <name>
```
...
### [waveshare_rp2040_lcd_demo_1_69](./examples/waveshare_rp2040_lcd_demo_1_69.rs)
