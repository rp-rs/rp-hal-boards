...
```toml
pimoroni-plasma-stick-2040-w = "0.1.0"
```

In your program, you will need to call `pimoroni_plasma_stick_2040_w::Pins::new` to create
...
```console
rp-hal-boards/boards/pimoroni-plasma-stick-2040-w $ cargo build --release --example <name>
```
...
```console
rp-hal-boards/boards/pimoroni-plasma-stick-2040-w $ cargo run --release --example <name>
```
...
### [pimoroni_plasma_stick_2040_w_ws2812_led](./examples/pimoroni_plasma_2040_ws2812_led.rs)
