...
use pimoroni_plasma_stick_2040_w::hal::prelude::*;

// A shorter alias for the Peripheral Access Crate, which provides low-level
// register access
use pimoroni_plasma_stick_2040_w::hal::pac;

// Import the Timer for Ws2812:
use pimoroni_plasma_stick_2040_w::hal::timer::Timer;

// A shorter alias for the Hardware Abstraction Layer, which provides
// higher-level drivers.
use pimoroni_plasma_stick_2040_w::hal;

// PIOExt for the split() method that is needed to bring
// PIO0 into useable form for Ws2812:
use pimoroni_plasma_stick_2040_w::hal::pio::PIOExt;
...
///
/// The `#[pimoroni_plasma_stick_2040_w::entry]` macro ensures the Cortex-M start-up code calls this function
/// as soon as all global variables and the spinlock are initialised.
#[pimoroni_plasma_stick_2040_w::entry]
fn main() -> ! {
    ...
    let clocks = hal::clocks::init_clocks_and_plls(
        pimoroni_plasma_stick_2040_w::XOSC_CRYSTAL_FREQ,
        pac.XOSC,
        pac.CLOCKS,
        pac.PLL_SYS,
        pac.PLL_USB,
    ...
    let pins = pimoroni_plasma_stick_2040_w::Pins::new(
        pac.IO_BANK0,
        pac.PADS_BANK0,
        sio.gpio_bank0,
        &mut pac.RESETS,
