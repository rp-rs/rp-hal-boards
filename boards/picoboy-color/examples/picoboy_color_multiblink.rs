//! # Picoboy Color Multiblink Example
//!
//! Blinks the red, yellow and green LED on a Picoboy Color.
//!
//! This will blink an LED attached to GP14, GP13, GP12 which is the pin the Picoboy Color uses for
//! the on-board LED.
//!
