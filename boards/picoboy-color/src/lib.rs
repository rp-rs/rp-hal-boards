...
//! A Hardware Abstraction Layer for the Picoboy Color.
//!
//! This crate serves as a HAL (Hardware Abstraction Layer) for the Picoboy Color. Since the Picoboy Color
...
hal::bsp_pins!(
    ...
    /// GPIO 23 is connected to b_power_save of the Picoboy Color.
    Gpio23 {
        name: b_power_save,
    },

    /// GPIO 24 is connected to vbus_detect of the Picoboy Color.
    Gpio24 {
        name: vbus_detect,
    },
    ...
    /// GPIO 29 is connected to voltage_monitor of the Picoboy Color.
    Gpio29 {
