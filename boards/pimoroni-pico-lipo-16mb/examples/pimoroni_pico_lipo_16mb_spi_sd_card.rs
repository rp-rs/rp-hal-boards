//! # Pico Lipo SD Card Example
//!
//! Reads and writes a file from/to the SD Card that is formatted in FAT32.
//! This example uses the SPI0 device of the Pimoroni Pico LiPo on the
...
use pimoroni_pico_lipo_16mb::hal::spi;

// Import the GPIO abstraction:
use pimoroni_pico_lipo_16mb::hal::gpio;
