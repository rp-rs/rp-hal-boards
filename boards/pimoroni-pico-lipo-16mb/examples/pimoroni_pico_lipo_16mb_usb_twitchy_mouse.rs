//! # Pico LiPo USB 'Twitchy' Mouse Example
//!
//! Creates a USB HID Class Pointing device (i.e. a virtual mouse) on a Pico LiPo
...
use pimoroni_pico_lipo_16mb::hal::pac::interrupt;
...
fn main() -> ! {
    ...
    #[cfg(feature = "rp2040-e5")]
    {
        ...
        let _pins = pimoroni_pico_lipo_16mb::Pins::new(
            pac.IO_BANK0,
            pac.PADS_BANK0,
            sio.gpio_bank0,
            &mut pac.RESETS,
