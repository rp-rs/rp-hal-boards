//! # Pico LiPo WS2812 RGB LED Example
//!
//! Drives 3 WS2812 LEDs connected directly to the Pimoroni Pico LiPo.
//! This assumes you drive the Pimoroni Pico LiPo via USB power, so that VBUS
...
//! Pimoroni Pico LiPo, which is GPIO4 of the rp2040. Here is a circuit
...
use pimoroni_pico_lipo_16mb::hal::timer::Timer;
...
use pimoroni_pico_lipo_16mb::hal::pio::PIOExt;
